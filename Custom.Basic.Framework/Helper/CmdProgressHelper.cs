...
namespace Custom.Basic.Framework.Helper
{
    ...
    /// CmdProgressHelper
    /// </summary>
    public class CmdProgressHelper : IDisposable
    {
        ...
        public CmdProgressHelper(string yourNmae)
            : this()
        {
            cmdName = yourNmae;
        }
        ...
        private bool RunCmd(string yourCmd)
        {
    ...
    class StreamAsynRead : IDisposable
    {
        ...
        private void GetDataThread(object ReceiveStream)
        {
            ...
            int bytes = receiveStream.Read(read, 0, length);
            ...
            while (bytes > 0 && !willKill)
            {
                ...
                PutOutData(re);
                bytes = receiveStream.Read(read, 0, length);
            }
        }
