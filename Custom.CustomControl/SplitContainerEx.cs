...
{
    [ToolboxItem(true), ToolboxBitmap(typeof(SplitContainer))]
    public class SplitContainerEx : SplitContainer
    {
        ...
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never), Description("分割器宽度")]
        ...
        public void CollpaseOrExpand()
        {
            ...
            else
            {
                ...
                if (CollpasePanel == SplitterPanelEnum.Panel2)
                {
